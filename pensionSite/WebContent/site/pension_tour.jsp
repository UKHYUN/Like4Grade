...
<div class="col-md-8 col-md-offset-2 entireDiv">
		...
		<ul class="nav nav-pills nav-justified menuDiv">
			...
			<li class="active"><a href="pension_tour.jsp">관광지별</a></li>
		</ul>
	...
	<div class="col-md-12 areaMenu_Div">
		...
		<div class="thema_section_tab">
			<div class="thema_section_tab">
				<ul>
					<a href="pension_tour.jsp?tour_code=01"><li class="active"><span>남이섬</span></li></a>
					<a href="pension_tour.jsp?tour_code=02"><li><span>해운대</span></li></a>
					<a href="pension_tour.jsp?tour_code=03"><li><span>전주한옥마을</span></li></a>
				</ul>
			</div>
		</div>
	
<%@ include file="pension_tour_view.jsp"%>
